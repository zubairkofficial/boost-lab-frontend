...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    primary: `bg-gradient-to-r from-primary via-cyber-blue to-neon-cyan text-white font-bold shadow-lg hover:shadow-cyber-lg
    ...
    outline: 'border border-primary/20 text-white hover:bg-primary/10 hover:border-primary/40'
  }
