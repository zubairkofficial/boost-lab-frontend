...
//           className="absolute top-12 rotate-358 right-49 transition-all duration-300"
//         >
//           <path
...
//           className="absolute top-4 left-64 transition-all duration-300"
//         >
//           <path
...
//           <span
//             className={`text-white font-bold text-lg tracking-wider transition-all duration-300 ${isHovered ? "text-cyan-100 scale-105" : ""}`}
//           >
//             {children}
//           </span>
//         </div>
...
// function Demo() {
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-slate-900 via-teal-900 to-slate-900 flex items-center justify-center p-8">
//       <div className="space-y-8 text-center">
//         <h1 className="text-4xl font-bold text-white mb-12">Futuristic Button Component</h1>

//         <div className="space-y-6">
//           <div>
//             <h2 className="text-xl text-cyan-300 mb-4">Default Button</h2>
//             <FuturisticButton onClick={() => alert("Button clicked!")} />
//           </div>

//           <div>
//             <h2 className="text-xl text-cyan-300 mb-4">Custom Text</h2>
//             <FuturisticButton onClick={() => alert("Get started!")}>GET STARTED</FuturisticButton>
//           </div>

//           <div>
//             <h2 className="text-xl text-cyan-300 mb-4">As Link</h2>
//             <FuturisticButton href="#pricing">VIEW PRICING</FuturisticButton>
//           </div>

//           <div>
//             <h2 className="text-xl text-cyan-300 mb-4">Multiple Buttons</h2>
//             <div className="flex flex-wrap gap-4 justify-center">
//               <FuturisticButton>EXPLORE</FuturisticButton>
//               <FuturisticButton>DISCOVER</FuturisticButton>
//               <FuturisticButton>LAUNCH</FuturisticButton>
//             </div>
//           </div>
//         </div>
//       </div>
...
//   const buttonContent = (
//     <div
//  className={`relative inline-block cursor-pointer transition-all duration-300 scale-75 md:scale-100 ${className}`}      onMouseEnter={() => setIsHovered(true)}
//       onMouseLeave={() => setIsHovered(false)}
//       onClick={onClick}
//     >
//       {/* Glow effect */}
...
//           isHovered ? "opacity-70 shadow-[0_0_150px_10px_rgba(142,240,244,0.8)]" : "opacity-0"
//         }`}
//       ></div>
...
//         {/* Additional decorative element - chevron pattern */}
//         <div className="absolute bottom-25 right-1 transition-all duration-300">
//           <div className={`transition-all duration-300 ${isHovered ? "opacity-80" : "opacity-60"}`}>
//             <svg width="131" height="10" viewBox="0 0 131 10" fill="none">
...
//         {/* Button text */}
//         <div className="absolute inset-0 flex items-center justify-center">
//           <span className="text-white font-bold text-lg tracking-wider transition-all duration-300">
//             {children}
//           </span>
//         </div>
//       </div>
