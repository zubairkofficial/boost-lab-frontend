...
import { useSignupMutation } from '../features/auth/authApi' // ✅ Use signup mutation instead
...
export const SignUpPage = () => {
  ...
  // ✅ Call /register instead of /register/send-otp
    ...
    <div className="min-h-screen bg-gradient-to-br from-dark-blue via-dark-grey to-ui-dark relative overflow-hidden font">
      ...
      <div className="relative z-30 flex flex-col justify-center items-center min-h-screen px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-8 sm:py-12">
        <div className="w-full max-w-lg mx-auto">
          {/* Form Container */}
          <div
            className={`bg-ui-medium/50 backdrop-blur-sm border border-[#8ef0f4] rounded-2xl p-8 transition-all duration-1000 delay-500 ${
          ...
          >
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1">
                  ...
                  >
                    ...
                    <a
                      href="#"
                      className="text-primary hover:text-cyber-blue transition-colors duration-300"
                    >
                      Terms of Service
                    </a>{' '}
                    and{' '}
            ...
            <div className="text-center mt-8">
              <p className="text-gray-300">
                ...
                <Link
                  to="/auth/login"
                  className="text-primary hover:text-cyber-blue transition-colors duration-300 font-semibold"
                >
                  Sign in here
                </Link>
              </p>
