  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-dark-blue via-dark-grey to-ui-dark relative overflow-hidden">
      ...
      <div className="relative z-30 flex flex-col justify-center items-center min-h-screen px-4 py-12">
        <div className={`w-full max-w-lg mx-auto bg-ui-medium/50 backdrop-blur-sm border border-white/20 rounded-2xl p-8 transition-all duration-1000 delay-500 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
