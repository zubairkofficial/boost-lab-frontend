  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "cyber-pattern":
          "linear-gradient(45deg, #0a0a1a 25%, transparent 25%), linear-gradient(-45deg, #0a0a1a 25%, transparent 25%), linear-gradient(45deg, transparent 75%, #0a0a1a 75%), linear-gradient(-45deg, transparent 75%, #0a0a1a 75%)",
        "grid-pattern":
          "linear-gradient(rgba(0, 255, 255, 0.1) 1px, transparent 1px), linear-gradient(90deg, rgba(0, 255, 255, 0.1) 1px, transparent 1px)",
        "gradient-primary":
          "linear-gradient(135deg, #0a0a1a 0%, #1a1a2e 50%, #16213e 100%)",
        "gradient-cyber":
          "linear-gradient(45deg, #00ffff, #008080, #00d4ff)",
        "gradient-portal":
          "linear-gradient(45deg, #ff4500, #ffd700, #ff6600)",
      },
      backdropBlur: {
        xs: "2px",
        sm: "4px",
